...
//					tempMyMenuEntry.gettView().setEllipsize(TruncateAt.MARQUEE);
//					tempMyMenuEntry.gettView().setSingleLine(true);
//					tempMyMenuEntry.gettView().setSelected(true);
//					tempMyMenuEntry.gettView().setMarqueeRepeatLimit(-1);
